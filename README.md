...
Fuera de la universidad, me formo continuamente en diferentes áreas de la informática. He orientado mi perfil hacia el **desarrollo web y móvil moderno**, trabajando activamente con **React, React Native, Next.js y NestJS**, usando principalmente **TypeScript** y **Tailwind CSS**. Mantengo una base sólida en **Java** y utilizo **Python** para resolver retos de programación y lógica.  
...
**Schoolyard Wheel**  
Generador de disposiciones mensuales de zonas de patio para el curso escolar. Es una forma sencilla y justa de repartir las zonas de vigilancia del patio a lo largo del año: sin hacerlo a mano, sin favoritismos y con un resultado fácil de compartir.
...
## Sobre Mí  
* Apasionado por la tecnología y la Ingeniería de Software.  
* Siempre aprendiendo nuevas herramientas y perfeccionando mi arquitectura de código.  
* Mi objetivo es convertirme en un **Desarrollador Full Stack** versátil.  
...
Outside of university, I continuously train in different areas of computer science. I have focused my profile on **modern web and mobile development**, actively working with **React, React Native, Next.js, and NestJS**, primarily using **TypeScript** and **Tailwind CSS**. I maintain a solid foundation in **Java** and use **Python** for programming challenges and logic solving.  
...
**Schoolyard Wheel**  
Monthly playground zone assignment generator for the school year. It is a simple and fair way to distribute playground supervision zones throughout the year: without doing it manually, without favoritism, and with an easily shareable result.
...
* Constantly learning new tools and improving my code architecture.  
